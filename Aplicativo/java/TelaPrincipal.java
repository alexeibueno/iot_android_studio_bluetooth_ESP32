package phila.alexei.app_bluetooth;
...
public class TelaPrincipal extends AppCompatActivity {
    ...
    public void ligar_clique(View v)
    {
        //Vejo se está conectado
        if(conexao){
            //Envia a mensagem para o ESP32
            connectedThread.enviar("1"); //liga
        }else{
            Toast.makeText(this, "Bluetooth não está conectado", Toast.LENGTH_LONG).show();
        }
    }

    public void desligar_clique(View v)
    {
        //Vejo se está conectado
        if(conexao){
            //Envia a mensagem para o ESP32
            connectedThread.enviar("0"); //desliga
        }else{
            Toast.makeText(this, "Bluetooth não está conectado", Toast.LENGTH_LONG).show();
        }
    }
